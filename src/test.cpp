...
bool	MakeRequest(Request &request, int clientfd)
{
	...
	std::cout << "User-Agent: " << request.getHeader("User-Agent").getOk() << std::endl;
	std::cout << "Accept: " << request.getHeader("Accept").getOk() << std::endl;
	std::cout << "Accept-Language: " << request.getHeader("Accept-Language").getOk() << std::endl;
	std::cout << "Connection: " << request.getHeader("Connection").getOk() << std::endl;
	std::cout << "Referer: " << request.getHeader("Referer").getOk() << std::endl;
	std::cout << "Sec-Fetch-Dest: " << request.getHeader("Sec-Fetch-Dest").getOk() << std::endl;
	std::cout << "Sec-Fetch-Mode: " << request.getHeader("Sec-Fetch-Mode").getOk() << std::endl;		
	std::cout << "Sec-Fetch-Site: " << request.getHeader("Sec-Fetch-Site").getOk() << std::endl;
	return (true);
}
